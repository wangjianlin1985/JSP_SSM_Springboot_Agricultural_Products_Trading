		       ...
		       text: "求购管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ProductSeek/productSeek_add.jsp"
			    	   	},
			    		{
			    	   		text: "求购管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ProductSeek/productSeek_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "农产品预售管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ProductSell/productSell_add.jsp"
			    	   	},
			    		{
			    	   		text: "农产品预售管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ProductSell/productSell_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "农产品订单管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ProductOrder/productOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "农产品订单管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ProductOrder/productOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
