...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>ProductOrder/frontlist">农产品订单信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">订单id:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getOrderId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">农产品信息:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getProductSellObj().getProductName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">意向用户:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getUserObj().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">意向出价:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getPrice()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户备注:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getOrderMemo()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">下单时间:</div>
		<div class="col-md-10 col-xs-6"><%=productOrder.getAddTime()%></div>
	</div>
	<div class="row bottom15">
