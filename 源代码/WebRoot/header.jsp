...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">农产品交易网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>ProductClass/frontlist">农产品类别</a></li> -->
                <li><a href="<%=basePath %>ProductSeek/frontlist">农产品求购</a></li>
                <li><a href="<%=basePath %>ProductSell/frontlist">农产品预售</a></li>
                <!-- 
                <li><a href="<%=basePath %>ProductOrder/frontlist">农产品订单</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        <li><a href="<%=basePath %>ProductSeek/productSeek_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布农产品求购</a></li>
                        <li><a href="<%=basePath %>ProductSeek/frontUserlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的求购信息</a></li>
                        <li><a href="<%=basePath %>ProductOrder/frontUserlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的订单信息</a></li>
                        <li><a href="<%=basePath %>ProductSell/productSell_frontUserAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布预售农产品</a></li>
                        <li><a href="<%=basePath %>ProductSell/frontUserlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的预售</a></li>
                    	<li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp?user_name=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
	    ...
	    <style>#productTypeAddForm .form-group {margin-bottom:10px;}  </style>
      </div>
